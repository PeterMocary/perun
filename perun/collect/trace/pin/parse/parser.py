...
class PinStaticOutputParser:
    ...
    def __init__(self, static_data_file: str,
                 function_information: Dict[str, FunctionInfo] = None) -> None:
    ...
    def _parse_routines_table(self) -> None:
        ...
        """
        entry_format: List[str] = ['id', 'name', 'source_code_file_id', 'source_code_line_start',
    ...
    def _parse_basic_blocks_table(self) -> None:
        ...
        """
        entry_format: List[str] = ['id', 'function_name', 'location_in_function',
                                   'instructions_count', 'source_code_file_id', 'source_code_lines']
